...
<div class="container-fluid">
  ...
  <{else}>
    ...
    <tr>
      <td><{$faq.i}></td>
      <td><a href="copysfaq.php?op=delsfaq&categoryid=<{$faq.categoryid}>" class="btn btn-sm btn-danger"><{$smarty.const._TAD_DEL}></a></td>
      <td><{$faq.categoryid}></td>
      <td><{$faq.parentid}></td>
      <td><{$faq.name}></td>
      ...
      <td>
        ...
        <{elseif $faq.exist > 0}>
          <a href="copysfaq.php?op=listfaq&categoryid=<{$faq.categoryid}>"<{if $faq.exist > 0 and $faq.faq_number==0}>class="btn btn-sm btn-danger"<{/if}>><{$faq.exist}> FAQs</a>
        <{else}>
